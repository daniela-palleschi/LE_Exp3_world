...
PennController.Sequence("post_task_prac","post-task-start",randomize("post_task"),"send","final");
...
PennController.Template( PennController.GetTable( "master_spr_subset24_world_fake_8verbs.csv")// change this line for the appropriate experimental list
                         ...
                         variable => ["practice",
                                      "PennController", PennController(
                                          ...
                                          ,
                                          getImage("checkmark")
                                          //.print("30vw","50vh") // F-version
                                          .print("70vw","50vh")// J-version
                                          ,
                                          getImage("crossmark")
                                          //.print("70vw","50vh") // F-version
                                          .print("30vw","50vh")// J-version
                                          ,
                                          newTimer("name", 500)
                                          .start()
                                          .wait()
...
PennController.Template( PennController.GetTable( "master_spr_subset24_world_fake_8verbs.csv")
